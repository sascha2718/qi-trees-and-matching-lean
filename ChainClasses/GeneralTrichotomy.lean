...
* `ae_gPairQI_symm`, `ae_not_gPairQI_symm`: almost sure quasi-isometry of a pair, and its
...
/-- Almost sure quasi-isometry of a pair of laws is symmetric. -/
lemma ae_gPairQI_symm {L L' : GSampleLaw}
