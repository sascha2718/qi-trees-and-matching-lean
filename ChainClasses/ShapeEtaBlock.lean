...
`thm:shape-coupling`\labelcref{it:shape-coupling-eta}, in the form the label graph of
...
/-- **`thm:shape-coupling`\labelcref{it:shape-coupling-eta}, the summation.** The analogue
...
/-- **`thm:shape-coupling`\labelcref{it:shape-coupling-eta}** over the size data: the
