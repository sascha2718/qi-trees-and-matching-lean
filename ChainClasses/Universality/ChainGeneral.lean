...
* `gCopyAddr_congr`, `flatShape`, `gCopyAddr_liftN_flatShape`, `skelToFlat`,
  `skelToFlat_injective`, `skelToFlat_surjective`, `dist_skelToFlat`: **the flat
  assembly is the skeleton assembly of the bare-neck shapes**, isometrically.
...
* `measurable_chainEnc`, `measurable_crossEnc`, `measurableSet_chain_match`: the matching
  event is measurable.
* `chain_general_rate`, `chain_general_ae_small`,
...
most one half: clause `it:matched-support` of `thm:matched-presentation`. -/
