...
* `mem_sample_iff_prefix`, `gArityAt_of_not_mem_sample`, `gArityAt_le_alphabet`: the
  arity field vanishes off the skeleton and is bounded by the alphabet.
...
* `measurableSet_engine_match`, `exists_gCouplings_all`, `hairy_general_rate`,
  `hairy_general_ae_small`, `hairy_general_ae_small'`:
