/-
The forced-source screen rows of the general-νR transfer lemma
...
* `crossInterpScreen_forced_step`: the one-step descent: the interpreted
  screen at `Z_i` equals the pair-level dead-member mass under the
  descended normalization;
* `crossERowZ_none`: the unit normalization: two full-list successor screens
...
* `eRowZ_fresh`: the fresh normalization `F`: the tilt converts to the
  mixture weight times `RT · TνR` (the root factor and the charged
...
lemma crossInterpScreen_forced_step (SL SR : Finset ℕ)
    (hSsupp : ∀ j : ℕ, (νR j : ℝ≥0∞) ≠ 0 ↔ j ∈ SR) (hrefl : Rv v0 v0)
    (hpos : rE μ Rv v0 ≠ 0) (i : ℕ) (z : Finset Tgt)
    (hzf : ∀ t ∈ z, ∀ m, t ≠ Tgt.Fk m) (u : Option Tgt) (h : ℕ) :
    crossInterpScreen α Rv μ νL νR v0 (h + 1) ⟨Tgt.Z i, z, u⟩
      = ∑' xp, Xi μ νL v0 i h xp
          * ((if ∀ p ∈ memPairs μ νR v0 SR h z,
                rE (prodPMF p.1 p.2)
                  (SquareRel (fullSim (labRel Rv) h)) xp = 0
              then (1 : ℝ≥0∞) else 0)
            * interpNorm α Rv μ νR v0 (h + 1) u (branch (v0, i) xp)) := by
  have _SL := SL
  have hstep : crossInterpScreen α Rv μ νL νR v0 (h + 1) ⟨Tgt.Z i, z, u⟩
      = ∑' x, muM (varyK μ νL v0) (v0, i) (h + 1) x
          * (screenInd (fullSim (labRel Rv) (h + 1))
              ((z.toList).map (interpT μ νR v0 (h + 1))) x
            * interpNorm α Rv μ νR v0 (h + 1) u x) := by
    rw [crossInterpScreen, screenE]
    exact tsum_congr fun x => mul_assoc _ _ _
  have hmap : (∑' x, muM (varyK μ νL v0) (v0, i) (h + 1) x
        * (screenInd (fullSim (labRel Rv) (h + 1))
            ((z.toList).map (interpT μ νR v0 (h + 1))) x
          * interpNorm α Rv μ νR v0 (h + 1) u x))
      = ∑' xp, Xi μ νL v0 i h xp
          * (screenInd (fullSim (labRel Rv) (h + 1))
              ((z.toList).map (interpT μ νR v0 (h + 1))) (branch (v0, i) xp)
            * interpNorm α Rv μ νR v0 (h + 1) u (branch (v0, i) xp)) := by
    rw [muM_varyK_succ μ νL v0 v0 i h]
    exact tsum_map_mul _ _ _
  rw [hstep, hmap]
  refine tsum_congr fun xp => ?_
  rw [screenInd, if_congr
    (memInd_branch_iff μ νR v0 Rv SR hSsupp hrefl hpos i h z hzf xp) rfl rfl]
...
lemma crossERowZ_none (SL SR : Finset ℕ)
    (hSsupp : ∀ j : ℕ, (νR j : ℝ≥0∞) ≠ 0 ↔ j ∈ SR) (hrefl : Rv v0 v0)
    (hpos : rE μ Rv v0 ≠ 0) (i : ℕ) (z : Finset Tgt)
    (hzf : ∀ t ∈ z, ∀ m, t ≠ Tgt.Fk m) (_hz : z.Nonempty) (h : ℕ)
    (E' : ℝ≥0∞)
    (hscrS : ∀ t' ∈ zsucc SR z, ∀ c' ∈ gpair i,
      screenE (interpT μ νL v0 h c') (fullSim (labRel Rv) h)
        [interpT μ νR v0 h t'] (fun _ => (1 : ℝ≥0∞)) ≤ E') :
    crossInterpScreen α Rv μ νL νR v0 (h + 1) ⟨Tgt.Z i, z, none⟩
      ≤ 2 * (∑ sc' ∈ crossScreenSucc SL SR ⟨Tgt.Z i, z, none⟩,
            crossInterpScreen α Rv μ νL νR v0 h sc')
        + ((zsucc SR z).card * E') * ((zsucc SR z).card * E') := by
  have hLHS : crossInterpScreen α Rv μ νL νR v0 (h + 1) ⟨Tgt.Z i, z, none⟩
      = ∑' xp : FullLab (V × ℕ) h × FullLab (V × ℕ) h,
          prodPMF (interpT μ νL v0 h (gcomp0 i))
            (interpT μ νL v0 h (gcomp1 i)) xp
          * ((if ∀ p ∈ memPairs μ νR v0 SR h z,
                rE (prodPMF p.1 p.2)
                  (SquareRel (fullSim (labRel Rv) h)) xp = 0
              then (1 : ℝ≥0∞) else 0)
            * ((fun _ => (1 : ℝ≥0∞)) xp.1
              * (fun _ => (1 : ℝ≥0∞)) xp.2)) := by
    rw [crossInterpScreen_forced_step α Rv μ νL νR v0 SL SR hSsupp hrefl hpos i z hzf
      none h, ← Xi_eq_prod μ νL v0 i h]
    refine tsum_congr fun xp => ?_
    show Xi μ νL v0 i h xp
        * ((if ∀ p ∈ memPairs μ νR v0 SR h z,
              rE (prodPMF p.1 p.2)
                (SquareRel (fullSim (labRel Rv) h)) xp = 0
    ...
    rw [one_mul]
  have hMF := hallFactorize (interpT μ νL v0 h (gcomp0 i))
    (interpT μ νL v0 h (gcomp1 i)) (fullSim (labRel Rv) h)
    (memPairs μ νR v0 SR h z)
    (((zsucc SR z).toList).map (interpT μ νR v0 h))
    (memPairs_mem μ νR v0 SR h z) (memPairs_cov μ νR v0 SR h z)
    (fun _ => (1 : ℝ≥0∞)) (fun _ => (1 : ℝ≥0∞))
  refine le_trans (le_of_eq hLHS) (le_trans hMF ?_)
  have hmass0 : (∑' x, interpT μ νL v0 h (gcomp0 i) x
      * (fun _ => (1 : ℝ≥0∞)) x) = 1 := by
    simp only [mul_one]
    exact (interpT μ νL v0 h (gcomp0 i)).tsum_coe
  have hmass1 : (∑' x, interpT μ νL v0 h (gcomp1 i) x
      * (fun _ => (1 : ℝ≥0∞)) x) = 1 := by
    simp only [mul_one]
    exact (interpT μ νL v0 h (gcomp1 i)).tsum_coe
  have h1 : screenE (interpT μ νL v0 h (gcomp0 i)) (fullSim (labRel Rv) h)
      (((zsucc SR z).toList).map (interpT μ νR v0 h))
      (fun _ => (1 : ℝ≥0∞))
      * (∑' x, interpT μ νL v0 h (gcomp1 i) x * (fun _ => (1 : ℝ≥0∞)) x)
      ≤ ∑ sc' ∈ crossScreenSucc SL SR (⟨Tgt.Z i, z, none⟩ : GScreen),
          crossInterpScreen α Rv μ νL νR v0 h sc' := by
    rw [hmass1, mul_one,
      ← crossInterpScreen_zsucc_none α Rv μ νL νR v0 SR h (gcomp0 i) z]
    exact crossInterp_le_succ_sum α Rv μ νL νR v0 h
      (mem_crossScreenSucc_mk (gcomp_mem_gpair i).1 (none_mem_normSucc SR))
  have h2 : (∑' x, interpT μ νL v0 h (gcomp0 i) x
      * (fun _ => (1 : ℝ≥0∞)) x)
      * screenE (interpT μ νL v0 h (gcomp1 i)) (fullSim (labRel Rv) h)
        (((zsucc SR z).toList).map (interpT μ νR v0 h))
        (fun _ => (1 : ℝ≥0∞))
      ≤ ∑ sc' ∈ crossScreenSucc SL SR (⟨Tgt.Z i, z, none⟩ : GScreen),
          crossInterpScreen α Rv μ νL νR v0 h sc' := by
    rw [hmass0, one_mul,
      ← crossInterpScreen_zsucc_none α Rv μ νL νR v0 SR h (gcomp1 i) z]
    exact crossInterp_le_succ_sum α Rv μ νL νR v0 h
      (mem_crossScreenSucc_mk (gcomp_mem_gpair i).2 (none_mem_normSucc SR))
  have hsum0 : ((((zsucc SR z).toList).map (interpT μ νR v0 h)).map
      fun ρ => screenE (interpT μ νL v0 h (gcomp0 i))
  ...
  have hsum1 : ((((zsucc SR z).toList).map (interpT μ νR v0 h)).map
      fun ρ' => screenE (interpT μ νL v0 h (gcomp1 i))
        (fullSim (labRel Rv) h) [ρ'] (fun _ => (1 : ℝ≥0∞))).sum
      ≤ (zsucc SR z).card * E' := by
    refine le_trans (list_map_sum_le _ _ E' fun ρ hρ => ?_) (le_of_eq ?_)
    · obtain ⟨t', ht', rfl⟩ := List.mem_map.mp hρ
...
singleton charges. -/
private lemma crossERowZ_W_cell (hα : 1 ≤ α) (SL SR : Finset ℕ) (i m h : ℕ)
    (z : Finset Tgt) (M E' Eplus : ℝ≥0∞)
    (hMom : ∀ c' ∈ gpair i, ∀ w' ∈ gpair m,
      PhiDres α (interpT μ νL v0 h c') (interpT μ νR v0 h w') (fullSim (labRel Rv) h) ≤ M)
    (hscrS : ∀ t' ∈ zsucc SR z, ∀ c' ∈ gpair i, ∀ w' ∈ gpair m,
      screenE (interpT μ νL v0 h c') (fullSim (labRel Rv) h)
        [interpT μ νR v0 h t']
        (WresD α (interpT μ νR v0 h w') (fullSim (labRel Rv) h)) ≤ E')
    (hEplus : ∀ c' ∈ gpair i, ∀ w' ∈ gpair m,
      crossInterpScreen α Rv μ νL νR v0 h ⟨c', zsucc SR z, some w'⟩ ≤ Eplus)
    (hEplusE : ∀ c' ∈ gpair i, ∀ w' ∈ gpair m,
      crossInterpScreen α Rv μ νL νR v0 h ⟨c', zsucc SR z, some w'⟩ ≤ E') :
    ∑' xp, Xi μ νL v0 i h xp
        * ((if ∀ p ∈ memPairs μ νR v0 SR h z,
              rE (prodPMF p.1 p.2)
                (SquareRel (fullSim (labRel Rv) h)) xp = 0
  ...
  have hsplit : ∀ xp : FullLab (V × ℕ) h × FullLab (V × ℕ) h,
      ...
      ≤ Xi μ νL v0 i h xp
          * ((if ∀ p ∈ memPairs μ νR v0 SR h z,
                rE (prodPMF p.1 p.2)
                  (SquareRel (fullSim (labRel Rv) h)) xp = 0
              then (1 : ℝ≥0∞) else 0)
            * (WresD α (interpT μ νR v0 h (gcomp0 m))
                (fullSim (labRel Rv) h) xp.1
              * WresD α (interpT μ νR v0 h (gcomp1 m))
    ...
    intro xp
    have hW : WresD α (Xi μ νR v0 m h)
        (SquareRel (fullSim (labRel Rv) h)) xp
        ≤ WresD α (interpT μ νR v0 h (gcomp0 m))
            (fullSim (labRel Rv) h) xp.1
            * WresD α (interpT μ νR v0 h (gcomp1 m))
  ...
  have horder : ∀ wa ∈ gpair m, ∀ wb ∈ gpair m,
        ...
        Xi μ νL v0 i h xp
          * ((if ∀ p ∈ memPairs μ νR v0 SR h z,
                rE (prodPMF p.1 p.2)
                  (SquareRel (fullSim (labRel Rv) h)) xp = 0
              then (1 : ℝ≥0∞) else 0)
            * (WresD α (interpT μ νR v0 h wa)
                (fullSim (labRel Rv) h) xp.1
              * WresD α (interpT μ νR v0 h wb)
                  (fullSim (labRel Rv) h) xp.2)))
    ...
    have hMF := hallFactorize (interpT μ νL v0 h (gcomp0 i))
      ...
      (((zsucc SR z).toList).map (interpT μ νR v0 h))
      (memPairs_mem μ νR v0 SR h z) (memPairs_cov μ νR v0 SR h z)
      (WresD α (interpT μ νR v0 h wa) (fullSim (labRel Rv) h))
      (WresD α (interpT μ νR v0 h wb) (fullSim (labRel Rv) h))
    refine le_trans (le_of_eq (tsum_congr fun xp => by
      rw [Xi_eq_prod μ νL v0 i h])) (le_trans hMF ?_)
    ...
    have hout1 : screenE (interpT μ νL v0 h (gcomp0 i))
        (fullSim (labRel Rv) h)
        (((zsucc SR z).toList).map (interpT μ νR v0 h))
        (WresD α (interpT μ νR v0 h wa) (fullSim (labRel Rv) h))
        * (∑' x, interpT μ νL v0 h (gcomp1 i) x
            * WresD α (interpT μ νR v0 h wb) (fullSim (labRel Rv) h) x)
        ≤ Eplus + ENNReal.ofReal α * M * E' := by
      rw [← crossInterpScreen_zsucc_some α Rv μ νL νR v0 SR h
        (gcomp0 i) wa z]
      calc crossInterpScreen α Rv μ νL νR v0 h ⟨gcomp0 i, zsucc SR z, some wa⟩
          * (∑' x, interpT μ νL v0 h (gcomp1 i) x
              * WresD α (interpT μ νR v0 h wb) (fullSim (labRel Rv) h) x)
          ≤ crossInterpScreen α Rv μ νL νR v0 h ⟨gcomp0 i, zsucc SR z, some wa⟩
            * (1 + ENNReal.ofReal α * M) :=
            mul_le_mul_right
              (hmomW (gcomp1 i) (gcomp_mem_gpair i).2 wb hwb) _
        _ = crossInterpScreen α Rv μ νL νR v0 h ⟨gcomp0 i, zsucc SR z, some wa⟩
            + ENNReal.ofReal α * M
              * crossInterpScreen α Rv μ νL νR v0 h
                  ⟨gcomp0 i, zsucc SR z, some wa⟩ := by ring
    ...
    have hout2 : (∑' x, interpT μ νL v0 h (gcomp0 i) x
          * WresD α (interpT μ νR v0 h wa) (fullSim (labRel Rv) h) x)
        * screenE (interpT μ νL v0 h (gcomp1 i)) (fullSim (labRel Rv) h)
          (((zsucc SR z).toList).map (interpT μ νR v0 h))
          (WresD α (interpT μ νR v0 h wb) (fullSim (labRel Rv) h))
        ≤ Eplus + ENNReal.ofReal α * M * E' := by
      rw [← crossInterpScreen_zsucc_some α Rv μ νL νR v0 SR h
        (gcomp1 i) wb z]
      calc (∑' x, interpT μ νL v0 h (gcomp0 i) x
            * WresD α (interpT μ νR v0 h wa) (fullSim (labRel Rv) h) x)
          * crossInterpScreen α Rv μ νL νR v0 h ⟨gcomp1 i, zsucc SR z, some wb⟩
          ≤ (1 + ENNReal.ofReal α * M)
            * crossInterpScreen α Rv μ νL νR v0 h ⟨gcomp1 i, zsucc SR z, some wb⟩ :=
            mul_le_mul_left
              (hmomW (gcomp0 i) (gcomp_mem_gpair i).1 wa hwa) _
        _ = crossInterpScreen α Rv μ νL νR v0 h ⟨gcomp1 i, zsucc SR z, some wb⟩
            + ENNReal.ofReal α * M
              * crossInterpScreen α Rv μ νL νR v0 h
                  ⟨gcomp1 i, zsucc SR z, some wb⟩ := by ring
        _ ≤ Eplus + ENNReal.ofReal α * M * E' := by
    ...
    have hsum0 : ((((zsucc SR z).toList).map (interpT μ νR v0 h)).map
        fun ρ => screenE (interpT μ νL v0 h (gcomp0 i))
          ...
          (WresD α (interpT μ νR v0 h wa) (fullSim (labRel Rv) h))).sum
        ≤ (zsucc SR z).card * E' := by
    ...
    have hsum1 : ((((zsucc SR z).toList).map (interpT μ νR v0 h)).map
        fun ρ' => screenE (interpT μ νL v0 h (gcomp1 i))
          (fullSim (labRel Rv) h) [ρ']
          (WresD α (interpT μ νR v0 h wb) (fullSim (labRel Rv) h))).sum
        ≤ (zsucc SR z).card * E' := by
      refine le_trans (list_map_sum_le _ _ E' fun ρ hρ => ?_)
        (le_of_eq ?_)
      · obtain ⟨t', ht', rfl⟩ := List.mem_map.mp hρ
...
quadratic terms. -/
lemma crossERowZ_forced (hα : 1 ≤ α) (SL SR : Finset ℕ)
    (hSsupp : ∀ j : ℕ, (νR j : ℝ≥0∞) ≠ 0 ↔ j ∈ SR) (hrefl : Rv v0 v0)
    (hpos : rE μ Rv v0 ≠ 0) (i : ℕ) (z : Finset Tgt)
    ...
    (hscrS : ∀ t' ∈ zsucc SR z, ∀ c' ∈ gpair i, ∀ w' ∈ gpair m,
      screenE (interpT μ νL v0 h c') (fullSim (labRel Rv) h)
        [interpT μ νR v0 h t']
        (WresD α (interpT μ νR v0 h w') (fullSim (labRel Rv) h)) ≤ E')
    (hE : ∀ sc' ∈ crossScreenSucc SL SR ⟨Tgt.Z i, z, some (Tgt.Z m)⟩,
      crossInterpScreen α Rv μ νL νR v0 h sc' ≤ E') :
    crossInterpScreen α Rv μ νL νR v0 (h + 1) ⟨Tgt.Z i, z, some (Tgt.Z m)⟩
      ≤ 4 * (∑ sc' ∈ crossScreenSucc SL SR ⟨Tgt.Z i, z, some (Tgt.Z m)⟩,
            crossInterpScreen α Rv μ νL νR v0 h sc')
        + 4 * (ENNReal.ofReal α * M * E')
        + 2 * (((zsucc SR z).card * E') * ((zsucc SR z).card * E')) := by
  have hdesc : crossInterpScreen α Rv μ νL νR v0 (h + 1) ⟨Tgt.Z i, z, some (Tgt.Z m)⟩
      = ∑' xp, Xi μ νL v0 i h xp
          * ((if ∀ p ∈ memPairs μ νR v0 SR h z,
                rE (prodPMF p.1 p.2)
                  (SquareRel (fullSim (labRel Rv) h)) xp = 0
    ...
    rw [crossInterpScreen_forced_step α Rv μ νL νR v0 SL SR hSsupp hrefl hpos i z hzf
      (some (Tgt.Z m)) h]
    refine tsum_congr fun xp => ?_
    have h1 := WresD_Zlaw_succ_branch α Rv μ νR v0 v0 m i h xp
    rw [if_pos hrefl] at h1
    rw [show interpNorm α Rv μ νR v0 (h + 1) (some (Tgt.Z m))
        (branch (v0, i) xp)
        = WresD α (Zlaw μ νR v0 m (h + 1)) (fullSim (labRel Rv) (h + 1))
            (branch (v0, i) xp) from rfl, h1]
  rw [hdesc]
  exact crossERowZ_W_cell α Rv μ νL νR v0 hα SL SR i m h z M E'
    (∑ sc' ∈ crossScreenSucc SL SR ⟨Tgt.Z i, z, some (Tgt.Z m)⟩,
      crossInterpScreen α Rv μ νL νR v0 h sc')
    hMom hscrS
    (fun c' hc' w' hw' => crossInterp_le_succ_sum α Rv μ νL νR v0 h
      (mem_crossScreenSucc_mk hc' (some_mem_normSucc hw')))
    (fun c' hc' w' hw' => hE _
      (mem_crossScreenSucc_mk hc' (some_mem_normSucc hw')))
...
private lemma tilt_exchange (w c W : ℝ≥0∞) (g : ℕ → ℝ≥0∞)
    (hW : W ≤ ∑' j, (if (νR j : ℝ≥0∞) = 0 then 0
        else (νR j : ℝ≥0∞) ^ (-α) * g j)) :
    w * (c * W)
      ≤ ∑' j, (if (νR j : ℝ≥0∞) = 0 then 0
          else (νR j : ℝ≥0∞) ^ (-α) * (w * (c * g j))) := by
  calc w * (c * W)
      ≤ w * (c * ∑' j, (if (νR j : ℝ≥0∞) = 0 then 0
          else (νR j : ℝ≥0∞) ^ (-α) * g j)) :=
        mul_le_mul_right (mul_le_mul_right hW _) _
    _ = ∑' j, w * (c * (if (νR j : ℝ≥0∞) = 0 then 0
          else (νR j : ℝ≥0∞) ^ (-α) * g j)) := by
        rw [ENNReal.tsum_mul_left, ENNReal.tsum_mul_left]
    _ = ∑' j, (if (νR j : ℝ≥0∞) = 0 then 0
          else (νR j : ℝ≥0∞) ^ (-α) * (w * (c * g j))) :=
        tsum_congr fun j => by
...
weighted by `νR_j^{-α}`, and each charged counter contributes one common tilted
cell, so the row costs `RT · TνR` times the forced-normalization
output. -/
lemma crossERowZ_fresh (hα : 1 ≤ α) (SL SR : Finset ℕ)
    (hSsupp : ∀ j : ℕ, (νR j : ℝ≥0∞) ≠ 0 ↔ j ∈ SR) (hrefl : Rv v0 v0)
    (hpos : rE μ Rv v0 ≠ 0) (i : ℕ) (z : Finset Tgt)
    (hzf : ∀ t ∈ z, ∀ m', t ≠ Tgt.Fk m') (_hz : z.Nonempty) (h : ℕ)
    (M E' TνR RT : ℝ≥0∞)
    ...
    (hMom : ∀ j ∈ SR, ∀ c' ∈ gpair i, ∀ w' ∈ gpair j,
      PhiDres α (interpT μ νL v0 h c') (interpT μ νR v0 h w') (fullSim (labRel Rv) h) ≤ M)
    (hscrS : ∀ j ∈ SR, ∀ t' ∈ zsucc SR z, ∀ c' ∈ gpair i, ∀ w' ∈ gpair j,
      screenE (interpT μ νL v0 h c') (fullSim (labRel Rv) h)
        [interpT μ νR v0 h t']
        (WresD α (interpT μ νR v0 h w') (fullSim (labRel Rv) h)) ≤ E')
    (hE : ∀ sc' ∈ crossScreenSucc SL SR ⟨Tgt.Z i, z, some Tgt.F⟩,
      crossInterpScreen α Rv μ νL νR v0 h sc' ≤ E') :
    crossInterpScreen α Rv μ νL νR v0 (h + 1) ⟨Tgt.Z i, z, some Tgt.F⟩
      ≤ RT * TνR
        * (4 * (∑ sc' ∈ crossScreenSucc SL SR ⟨Tgt.Z i, z, some Tgt.F⟩,
              crossInterpScreen α Rv μ νL νR v0 h sc')
          + 4 * (ENNReal.ofReal α * M * E')
          + 2 * (((zsucc SR z).card * E') * ((zsucc SR z).card * E'))) := by
  have hα0 : (0 : ℝ) ≤ α := le_trans zero_le_one hα
  have hdesc : crossInterpScreen α Rv μ νL νR v0 (h + 1) ⟨Tgt.Z i, z, some Tgt.F⟩
      = ∑' xp, Xi μ νL v0 i h xp
          * ((if ∀ p ∈ memPairs μ νR v0 SR h z,
                rE (prodPMF p.1 p.2)
                  (SquareRel (fullSim (labRel Rv) h)) xp = 0
    ...
    rw [crossInterpScreen_forced_step α Rv μ νL νR v0 SL SR hSsupp hrefl hpos i z hzf
      (some Tgt.F) h]
    refine tsum_congr fun xp => ?_
    rw [show interpNorm α Rv μ νR v0 (h + 1) (some Tgt.F)
        (branch (v0, i) xp)
        = WresD α (Tlaw μ νR v0 (h + 1)) (fullSim (labRel Rv) (h + 1))
            (branch (v0, i) xp) from rfl,
      WresD_Tlaw_succ_branch α Rv μ νR v0 v0 hpos i h xp]
              ...
              * ((if ∀ p ∈ memPairs μ νR v0 SR h z,
                ...
                * ((rE μ Rv v0) ^ (-α)
                  * WresD α (Xi μ νR v0 j h)
                      (SquareRel (fullSim (labRel Rv) h)) xp)))) := by
    intro xp
    refine tilt_exchange α νR _ _ _ _ ?_
    calc (rE μ Rv v0) ^ (-α)
        * WresD α (XiBar μ νR v0 h)
            (SquareRel (fullSim (labRel Rv) h)) xp
        ≤ (rE μ Rv v0) ^ (-α)
          * ∑' j, (if (νR j : ℝ≥0∞) = 0 then 0
                ...
                * WresD α (Xi μ νR v0 j h)
                    (SquareRel (fullSim (labRel Rv) h)) xp) :=
          mul_le_mul_right (WresD_XiBar_le_sum α Rv μ νR v0 hα0 h xp) _
      _ = ∑' j, (rE μ Rv v0) ^ (-α)
  ...
  have hterm : ∀ j : ℕ,
            ...
            * (Xi μ νL v0 i h xp
              * ((if ∀ p ∈ memPairs μ νR v0 SR h z,
                ...
                * ((rE μ Rv v0) ^ (-α)
                  * WresD α (Xi μ νR v0 j h)
                      (SquareRel (fullSim (labRel Rv) h)) xp)))))
      ≤ (if (νR j : ℝ≥0∞) = 0 then 0 else (νR j : ℝ≥0∞) ^ (-α))
        * (RT * (4 * (∑ sc' ∈ crossScreenSucc SL SR ⟨Tgt.Z i, z, some Tgt.F⟩,
              crossInterpScreen α Rv μ νL νR v0 h sc')
            + 4 * (ENNReal.ofReal α * M * E')
            + 2 * (((zsucc SR z).card * E')
              * ((zsucc SR z).card * E')))) := by
    ...
    · have hjS : j ∈ SR := (hSsupp j).mp hj0
      ...
      exact mul_le_mul' hRT (crossERowZ_W_cell α Rv μ νL νR v0 hα SL SR i j h z M E'
        (∑ sc' ∈ crossScreenSucc SL SR ⟨Tgt.Z i, z, some Tgt.F⟩,
          crossInterpScreen α Rv μ νL νR v0 h sc')
        (hMom j hjS) (hscrS j hjS)
        (fun c' hc' w' hw' => crossInterp_le_succ_sum α Rv μ νL νR v0 h
          (mem_crossScreenSucc_mk hc'
  ...
  refine le_trans (mul_le_mul_left hTνR _) (le_of_eq ?_)
  ring
