...
This chapter fixes the objects and states the three headline results. Their proofs are
assembled in \cref{ch:gw-simple} and \cref{ch:trichotomy}, on top of the matching
machinery of \cref{ch:iid} and \cref{ch:engine}.
...
\begin{proof}
\uses{thm:trichotomy}
The quasi-isometry supplied by \cref{thm:trichotomy} is the input; the passage to a
quasisymmetric homeomorphism of visual boundaries is the theorem of Buyalo and Schroeder.
That last step is not formalised.
\end{proof}
